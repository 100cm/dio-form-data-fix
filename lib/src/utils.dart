...
/// done.
Future writeStreamToSink(Stream stream, EventSink sink, int file_length,
    int all_file) {
  var completer = Completer();
  var yes = file_length == all_file;
  stream.listen(sink.add,
      onError: sink.addError,
      onDone: () => completer.complete(yes));
